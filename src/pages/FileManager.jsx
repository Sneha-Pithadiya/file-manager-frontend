...
import { FaEllipsis, FaXmark, FaExclamation, FaTriangleExclamation, FaCloudArrowUp } from "react-icons/fa6";
...
export default function FileManager() {
  ...
  const handleCreateFile = async () => {
    ...
    try {
      ...
      setFiles((prev) => [...prev, newFile]); // show in current folder
  ...
  const handleViewRecycleBin = async () => {
    try {
      ...
      // Set breadcrumb to indicate Recycle Bin
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-500 dark:bg-gray-900 transition-colors ">
      ...
      <FileManagerToolbar
        ...
        onNewFileClick={handleFileClick}
        ...
        sort={sortOrder}
        splitItems={[]}
        viewRecycleBin={handleViewRecycleBin} // <--- important
      />
          ...
          {filteredFiles.length === 0 ? (
            <div className="flex gap-5 justify-center items-center flex-col text-center p-4 text-gray-500 dark:text-gray-300 h-100 text-2xl">
              ...
              <div className="flex gap-2">
                <button onClick={onNewFolderClick} className="flex items-center px-4 py-2 bg-purple-500 border border-purple-500 text-white rounded shadow hover:bg-purple-600 transition">
                  <FaPlus className="inline mr-2 font-normal" />
                  Folder
                </button>
                <button
                  onClick={() => setShowFileModal(true)}
                  className="flex items-center px-4 py-2 bg-green-500 border border-green-500 text-white rounded shadow hover:bg-green-600 transition"
                >
                  <FaPlus className="inline mr-2 font-normal" />
                  File
                </button>
